...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是阿豪，靠天吃饭自由人一枚,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Nolan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '靠天吃饭自由人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nolanblog.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,Nolan,博客,阿豪', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3HyeT54ULhjv462B', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3HyeT54ULhjv462B', // ck，在51la后台获取
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'lpvb5unk8h', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
